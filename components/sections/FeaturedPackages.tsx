    ...
    <section id="packages" className="bg-sand-50 py-20 md:py-28">
      <Container>
        ...
        <div className="mt-12 text-center md:hidden">
          <Link
            href="/paket"
            className="inline-flex h-14 items-center justify-center gap-2 rounded-full border border-stone-300 bg-white px-7 text-base font-semibold text-stone-900 transition-all hover:border-brand-700 hover:text-brand-800"
          >
            Lihat Semua Paket
            <ArrowRight className="h-4 w-4" />
          </Link>
